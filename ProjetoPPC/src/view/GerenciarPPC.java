 ...
 * @author Gustavo
 */
public class GerenciarPPC extends javax.swing.JDialog {

    /**
     * Creates new form GerenciarPPC
     */
    public GerenciarPPC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerenciarPPC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GerenciarPPC dialog = new GerenciarPPC(new javax.swing.JFrame(), true);
