 ...
 * @author Gustavo
 */
public class CadastroAtaDeReuniao extends javax.swing.JDialog {

    /**
     * Creates new form CadastroAtaDeReuniao
     */
    public CadastroAtaDeReuniao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroAtaDeReuniao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroAtaDeReuniao dialog = new CadastroAtaDeReuniao(new javax.swing.JFrame(), true);
